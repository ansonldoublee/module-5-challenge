...
function renderTaskList() {
  ...
  $('.draggable').draggable({
    ...
    stop: function (event, ui) {
      ...
      const newStatus = $(ui.helper).parent().attr('id').replace('-cards', '');
      handleDrop(event, ui, taskId, newStatus);
    }
  });
}
...
function handleDrop(event, ui, taskId, newStatus) {
...
$(document).ready(function () {
  ...
  $('.lane').droppable({
    ...
    drop: function (event, ui) {
      ...
      const newStatus = $(this).attr('id').replace('-lane', '');
      handleDrop(event, ui, taskId, newStatus);
      renderTaskList(); // Update task list after drop
    },
  });
